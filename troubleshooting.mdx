...
Most widget problems fall into one of a few categories. The SDK isn't loading, a widget element isn't detected, a configuration is mismatched, or a Content Security Policy (CSP) is blocking requests. This page walks through the most common issues and how to fix them.
