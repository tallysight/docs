...
The Odds Text widget lets you display live betting odds inline within article text. Instead of a full odds card, you get a small formatted number that updates automatically. This is useful for placing the current line next to a team name or bet mention in a sentence — without interrupting the reading flow.
