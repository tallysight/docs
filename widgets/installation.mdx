...
Tallysight widgets load in two steps. First, you add a single SDK script tag to your page. Then you place one or more widget elements wherever you want a widget to appear. The SDK detects those elements automatically and loads the correct widget bundle from Tallysight's CDN.
