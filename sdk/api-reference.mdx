...
When you call `enableBetBuilder()`, the SDK creates a bet builder widget element, appends it to the document body, and loads the bundle. When you call `disableBetBuilder()`, the SDK removes all bet builder elements from the DOM and cleans up their state.
