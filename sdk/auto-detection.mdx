...
Auto-detection uses a MutationObserver to watch the DOM for newly added widget elements. When a widget element is added dynamically, the SDK automatically detects it and loads the corresponding widget bundle without any extra code on your part. This covers cases like a SPA router mounting new routes, a content management system rendering blocks on the fly, or an AJAX request injecting markup.
